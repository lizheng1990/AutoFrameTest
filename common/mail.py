...
class Mail:
    ...
    def __init__(self):
        ...
        self.mail_info['html'] = config.config['mail_html']
...
if __name__ == '__main__':
    ...
    mail = Mail()
    mail.mail_info['filepaths'] = ['G:\\gitHub\\AutoFrameTest\\lib\\results\\result-HTTP接口用例20190519210314.xls']
    mail.mail_info['filenames'] = ['result-HTTP接口用例20190519210314.xls']
